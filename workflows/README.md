...
|---|---|---|---|---|
| [`structural-solids`](structural-solids/) | 기계 2팀 | Mechanical/Workbench 또는 승인 MAPDL | 응력, 변위, 반력, 안전율 | 계약 초안 |
...
불변 artifact와 checksum을 확정한 뒤 NAVER WORKS Drive 같은 비공개 저장소가 맡는다.
